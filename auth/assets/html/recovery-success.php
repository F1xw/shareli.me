...
<html style="width: 100%;height: 100%;">
    <head>
        ...
        <meta name="description" content="Recover your password | shareli.me">
        ...
        <title>share.it - Recovery Success</title>
    </head>
    <body style="background-image: url('../assets/img/network-4851119_1920.jpg');">
        <div class="login-card">
            <p class="profile-name-card pb-3">Reset your password</p>
            <p class="text-center">You have been sent a link to reset your password.</p>
            <a class="btn btn-primary btn-block btn.lg rpl-btn rpl-rounded" href="../">Log In &nbsp;<i class="fas fa-arrow-right"></i></a>
        </div>
    </body>
</html>