...
if (!isset($_SESSION['loggedin']) || !isset($_SESSION['uid'])) {
    header('location: /auth/?ref=dashboard');
    exit;
}
...
<meta charset="UTF-8">
    ...
    <meta name="description" content="Account Dashboard | shareli.me">
    <title>shareli.me - Dashboard</title>
...
<body>
    ...
    <div class="collapse navbar-collapse" id="navContent">
        ...
        <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="dropdown-item active" href="/dashboard/">My Files</a>
    ...
    <div class="content-lite">
        <div class="row widgets">
            <div class="col-xl-6 widget">
                <div class="card">
                    <h4 class="text-center mt-4">Shared Files</h4>
                    <div class="row mr-3 ml-3 mt-2">
                        <div class="col-4 text-left"><span class="text-muted">File</span></div>
                        <div class="col-4 text-center"><span class="text-muted">Date</span></div>
                        <div class="col-4 text-right"><span class="text-muted">Downloads</span></div>
                    </div>
                    <hr>
                    <div class="card-body">
                        <ul class="list-group list-group-flush" ajax-content="files">
                            <li class="list-group-item d-flex justify-content-between align-items-center p-0">
                                <div class="row w-100 m-0 sceleton-load">
                                    <div class="col-4 text-left"><span class="sceleton-item">&nbsp;</span></div>
                                    <div class="col-4 text-center"><span class="sceleton-item">&nbsp;</span></div>
                                    <div class="col-4 text-right"><span class="sceleton-item">&nbsp;</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
